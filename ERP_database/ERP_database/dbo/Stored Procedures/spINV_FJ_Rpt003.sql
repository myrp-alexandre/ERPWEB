...
-- Description:	<>
-- =============================================
CREATE  PROCEDURE [dbo].[spINV_FJ_Rpt003] 	
	 @IdEmpresa int,
	 @IdSucursalIni int,
	 @IdSucursalFin int,
	 @IdBodegaIni int,
...
BEGIN
	...
	and b.cm_fecha = (select  max(movDet.cm_fecha)
						...
						and isnull(mov.IdCentroCosto,'') like '%'+@IdCentro_Costo+'%'
						and isnull(mov.IdCentroCosto_sub_centro_costo,'') like '%'+@IdSubcentro_Costo+'%'
						)
