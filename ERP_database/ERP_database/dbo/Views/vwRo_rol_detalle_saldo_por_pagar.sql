...
FROM     (SELECT rol.IdEmpresa, rol.IdRol, rol.IdNominaTipo, rol.IdNominaTipoLiqui, rol.IdPeriodo, rol_det.IdEmpleado, rol_det.IdRubro, rol_det.Valor AS ValorGanado, rol_det.IdSucursal, emp.em_codigo, persona.pe_apellido, persona.pe_nombre, 
                                    persona.pe_nombreCompleto, persona.pe_cedulaRuc, emp.em_NumCta, emp.em_tipoCta, persona.IdPersona
