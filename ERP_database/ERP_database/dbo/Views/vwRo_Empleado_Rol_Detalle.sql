...
SELECT        dbo.ro_empleado.IdEmpleado, dbo.tb_persona.pe_cedulaRuc AS CedulaRuc, dbo.tb_persona.pe_nombreCompleto AS NombreCompleto, dbo.ro_rol_detalle.IdRubro, dbo.ro_rubro_tipo.ru_codRolGen AS Tag, 
                         ...
                         dbo.ro_rol.Cerrado AS EstadoRol, dbo.ro_rol.IdCentroCosto, dbo.ro_periodo.IdPeriodo, dbo.ro_periodo.pe_anio, dbo.ro_periodo.pe_mes, dbo.ro_periodo.pe_FechaIni AS FechaIni, dbo.ro_periodo.pe_FechaFin AS FechaFin, 
                         dbo.ro_periodo_x_ro_Nomina_TipoLiqui.Cerrado, dbo.ro_periodo_x_ro_Nomina_TipoLiqui.Procesado, dbo.ro_periodo_x_ro_Nomina_TipoLiqui.Contabilizado, dbo.ro_empleado.em_tipoCta AS TipoCuenta, 
                         dbo.ro_empleado.em_NumCta AS NumCuenta, dbo.ro_empleado.IdBanco, dbo.tb_persona.IdTipoDocumento AS TipoIdentificacion, dbo.ro_empleado.IdDivision, dbo.ro_Division.Descripcion AS DivisionDescripcion, 
                         dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.tb_banco.CodigoLegal, dbo.ro_Departamento.IdDepartamento, dbo.tb_banco.ba_descripcion
FROM            dbo.tb_empresa INNER JOIN
                         ...
                         dbo.tb_banco ON dbo.ro_empleado.IdBanco = dbo.tb_banco.IdBanco RIGHT OUTER JOIN
                         ...
                         dbo.ro_Nomina_Tipoliqui.IdNomina_TipoLiqui = dbo.ro_rol.IdNominaTipoLiqui ON dbo.ro_rol_detalle.IdEmpresa = dbo.ro_rol.IdEmpresa AND dbo.ro_rol_detalle.IdRol = dbo.ro_rol.IdRol INNER JOIN
                         dbo.ro_rubro_tipo ON dbo.ro_rol_detalle.IdRubro = dbo.ro_rubro_tipo.IdRubro ON dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdEmpresa = dbo.ro_rol.IdEmpresa AND 
                         dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdNomina_Tipo = dbo.ro_rol.IdNominaTipo AND dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdNomina_TipoLiqui = dbo.ro_rol.IdNominaTipoLiqui AND 
                         dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdPeriodo = dbo.ro_rol.IdPeriodo INNER JOIN
                         dbo.ro_periodo ON dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdPeriodo = dbo.ro_periodo.IdPeriodo AND dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdEmpresa = dbo.ro_periodo.IdEmpresa ON 
                         dbo.ro_empleado.IdEmpleado = dbo.ro_rol_detalle.IdEmpleado AND dbo.ro_empleado.IdEmpresa = dbo.ro_rol_detalle.IdEmpresa
