...
/*select * from vwINV_Rpt011*/
CREATE VIEW [dbo].[vwINV_FJ_Rpt003]
AS
SELECT        dbo.in_movi_inve.IdEmpresa, dbo.in_movi_inve.IdSucursal, dbo.in_movi_inve.IdBodega, dbo.in_movi_inve.IdMovi_inven_tipo, dbo.in_movi_inve.IdNumMovi, 
                         ...
                         dbo.in_movi_inve_detalle.IdProducto, dbo.ct_centro_costo_sub_centro_costo.Centro_costo AS nom_subCentro_costo, 
                         dbo.ct_centro_costo.Centro_costo AS nom_Centro_costo, ISNULL(dbo.in_movi_inve_detalle.IdCentroCosto, '') AS idCentro_costo, 
                         ISNULL(dbo.in_movi_inve_detalle.IdCentroCosto_sub_centro_costo, '') AS idSubCentro_costo
