...
SELECT        dbo.ro_EmpleadoNovedadCargaMasiva_det.IdEmpresa, dbo.ro_EmpleadoNovedadCargaMasiva_det.IdCarga, dbo.ro_EmpleadoNovedadCargaMasiva_det.Secuencia, 
                         ...
                         dbo.ro_EmpleadoNovedadCargaMasiva_det.IdEmpleado, dbo.ro_empleado.em_codigo, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.tb_persona.pe_cedulaRuc
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwro_EmpleadoNovedadCargaMasiva_det';
