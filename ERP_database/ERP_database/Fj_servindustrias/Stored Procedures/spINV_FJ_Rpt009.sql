-- exec [Fj_servindustrias].[spINV_FJ_Rpt009] 1,1,9999,1,9999,1363,1363,'29/10/2017','29/11/2017','admin',1,1
CREATE PROCEDURE [Fj_servindustrias].[spINV_FJ_Rpt009] 	
@IdEmpresa int,
@IdSucursal_ini int,
@IdSucursal_fin int,
@IdBodega_ini int,
...
FROM (
				SELECT        det.IdEmpresa, det.IdSucursal, det.IdBodega, det.IdMovi_inven_tipo, in_Ing_Egr_Inven_det.IdNumMovi, det.Secuencia, det.IdProducto
						...
						in_Producto.pr_descripcion, in_UnidadMedida.IdUnidadMedida, in_UnidadMedida.Descripcion as nom_unidad_consumo, in_UnidadMedida.cod_alterno as cod_unidad_consumo, ct_punto_cargo.IdPunto_cargo, ct_punto_cargo.nom_punto_cargo
FROM            in_movi_inve AS cab INNER JOIN
                         ...
                         in_INV_Rpt010 ON in_Producto.IdEmpresa = in_INV_Rpt010.IdEmpresa AND in_Producto.IdProducto = in_INV_Rpt010.IdProducto ON det.IdEmpresa = in_INV_Rpt010.IdEmpresa AND 
                         det.IdSucursal = in_INV_Rpt010.IdSucursal AND det.IdBodega = in_INV_Rpt010.IdBodega AND det.IdProducto = in_INV_Rpt010.IdProducto INNER JOIN
                         in_UnidadMedida ON in_UnidadMedida.IdUnidadMedida = in_Producto.IdUnidadMedida_Consumo LEFT OUTER JOIN
                         ct_punto_cargo ON det.IdEmpresa = ct_punto_cargo.IdEmpresa AND det.IdPunto_cargo = ct_punto_cargo.IdPunto_cargo LEFT OUTER JOIN
                         ...
                         in_Ing_Egr_Inven_det.IdNumMovi = cp_Aprobacion_Ing_Bod_x_OC_det.IdNumMovi_Ing_Egr_Inv AND in_Ing_Egr_Inven_det.Secuencia = cp_Aprobacion_Ing_Bod_x_OC_det.Secuencia_Ing_Egr_Inv					 
						 LEFT JOIN (
		...
		) A ORDER BY A.IdEmpresa,A.IdSucursal,A.IdBodega,A.IdProducto,A.cm_fecha, A.cant_ing desc, a.IdNumMovi desc, a.Secuencia asc
