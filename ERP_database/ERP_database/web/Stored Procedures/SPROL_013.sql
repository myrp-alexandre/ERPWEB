...
SELECT        dbo.ro_empleado.IdDepartamento, dbo.ro_empleado.IdEmpleado, dbo.ro_periodo.pe_anio, dbo.ro_periodo.pe_FechaIni, dbo.ro_periodo.pe_FechaFin, dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_apellido, 
                         dbo.tb_persona.pe_nombre, dbo.ro_rubro_tipo.ru_descripcion, dbo.ro_Departamento.de_descripcion, dbo.ro_Nomina_Tipo.Descripcion AS Nomina, dbo.ro_cargo.ca_descripcion, dbo.ro_periodo.pe_mes, 
                         dbo.ro_empleado.em_fechaSalida, dbo.ro_empleado.em_fechaIngaRol, '' AS Descripcion, dbo.ro_rol_detalle_x_rubro_acumulado.Valor
FROM            dbo.ro_rol INNER JOIN
                         ...
                         dbo.ro_rubro_tipo ON dbo.ro_rol_detalle_x_rubro_acumulado.IdEmpresa = dbo.ro_rubro_tipo.IdEmpresa AND dbo.ro_rol_detalle_x_rubro_acumulado.IdRubro = dbo.ro_rubro_tipo.IdRubro ON 
                         dbo.ro_empleado.IdEmpresa = dbo.ro_rol_detalle_x_rubro_acumulado.IdEmpresa AND dbo.ro_empleado.IdEmpleado = dbo.ro_rol_detalle_x_rubro_acumulado.IdEmpleado ON 
                         dbo.ro_rol.IdEmpresa = dbo.ro_rol_detalle_x_rubro_acumulado.IdEmpresa AND dbo.ro_rol.IdRol = dbo.ro_rol_detalle_x_rubro_acumulado.IdRol INNER JOIN
                         ...
                         dbo.ro_Nomina_Tipo.IdEmpresa = dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdEmpresa AND dbo.ro_Nomina_Tipo.IdNomina_Tipo = dbo.ro_periodo_x_ro_Nomina_TipoLiqui.IdNomina_Tipo ON 
                         ...
                         dbo.ro_rol.IdEmpresa = dbo.ro_Nomina_Tipo.IdEmpresa AND dbo.ro_rol.IdNominaTipo = dbo.ro_Nomina_Tipo.IdNomina_Tipo
