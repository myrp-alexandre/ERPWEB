...
SELECT        dbo.ro_empleado.IdEmpresa, dbo.ro_empleado.IdEmpleado, dbo.tb_persona.IdPersona, dbo.ro_empleado_Novedad.IdNovedad, dbo.ro_empleado_novedad_det.FechaPago, dbo.ro_empleado_novedad_det.Valor, 
                         ...
                         dbo.ro_empleado_novedad_det.Observacion, dbo.ro_rubro_tipo.rub_Acuerdo_Descuento, dbo.ro_rubro_tipo.ru_descripcion, dbo.ro_catalogo.ca_descripcion AS EstadoCobro
FROM            dbo.ro_empleado INNER JOIN
                         ...
                         dbo.ro_Nomina_Tipoliqui ON dbo.ro_empleado_Novedad.IdNomina_TipoLiqui = dbo.ro_Nomina_Tipoliqui.IdNomina_TipoLiqui AND 
                         dbo.ro_empleado_Novedad.IdNomina_Tipo = dbo.ro_Nomina_Tipoliqui.IdNomina_Tipo INNER JOIN
