...
SELECT dbo.in_Ing_Egr_Inven_det.IdEmpresa, dbo.in_Ing_Egr_Inven_det.IdSucursal, dbo.in_Ing_Egr_Inven_det.IdMovi_inven_tipo, dbo.in_Ing_Egr_Inven_det.IdNumMovi, dbo.in_Ing_Egr_Inven_det.Secuencia, 
                  ...
                  dbo.in_Producto.lote_fecha_vcto, dbo.in_presentacion.nom_presentacion, dbo.in_Ing_Egr_Inven.signo, dbo.in_movi_inven_tipo.tm_descripcion, dbo.seg_usuario.Nombre AS NomUsuario
      ...
      Begin Tables = 
         ...
         Begin Table = "in_UnidadMedida"
            Begin Extent = 
               ...
               Left = 48
               Bottom = 1178
               Right = 2', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'VWINV_002';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'56
            End
            DisplayFlags = 280
            TopColumn = 0
         End
