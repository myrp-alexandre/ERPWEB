...
SELECT        dbo.tb_persona.pe_cedulaRuc AS CedulaRuc, dbo.tb_persona.pe_nombreCompleto AS NombreCompleto, dbo.ro_empleado_novedad_det.IdRubro, dbo.ro_empleado_novedad_det.FechaPago, 
                         ...
                         dbo.ro_Departamento.IdDepartamento, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.ro_cargo.ca_descripcion, ro_empleado.IdArea, ro_rubro_tipo.ru_tipo
FROM            dbo.ro_empleado_novedad_det INNER JOIN
                         ...
                         dbo.ro_empleado_Novedad.IdEmpleado = dbo.ro_empleado_Novedad.IdEmpleado AND dbo.ro_empleado.IdEmpresa = dbo.ro_empleado_Novedad.IdEmpresa AND 
...
WHERE        ro_empleado_novedad.Estado = 'A'
UNION ALL
SELECT        dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_nombreCompleto, dbo.ro_rubro_tipo.IdRubro, GETDATE() AS FechaPago, dbo.ro_empleado_x_ro_rubro.Valor, 'PEN' AS EstadoCobro, dbo.ro_rubro_tipo.ru_descripcion, 
                         dbo.ro_Division.Descripcion, dbo.ro_Departamento.de_descripcion, dbo.ro_empleado.IdEmpresa, dbo.ro_empleado.IdEmpleado, dbo.ro_empleado.IdDivision, dbo.ro_empleado.em_codigo, dbo.ro_empleado.IdDepartamento, 
                         dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.ro_cargo.ca_descripcion, ro_empleado.IdArea, ro_rubro_tipo.ru_tipo
