...
AS
SELECT dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, dbo.cp_orden_giro.IdProveedor, dbo.vwcp_ProveedorRuc.pr_nombre AS nom_proveedor, 
                  dbo.vwcp_ProveedorRuc.pe_cedulaRuc AS ced_proveedor, dbo.vwcp_ProveedorRuc.pe_direccion AS dir_proveedor, dbo.cp_orden_giro.co_fechaOg, dbo.cp_orden_giro.co_serie, dbo.cp_orden_giro.co_factura AS num_factura, 
