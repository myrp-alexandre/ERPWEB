...
AS
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, dbo.fa_factura.vt_NumFactura, dbo.fa_factura.vt_fecha, pe_nombreCompleto Nombres, dbo.fa_Vendedor.Ve_Vendedor, 
                  det.vt_Subtotal0, det.vt_SubtotalIVA, det.vt_iva, det.vt_total, dbo.fa_factura.Estado, dbo.fa_factura.esta_impresa, dbo.fa_factura_x_in_Ing_Egr_Inven.IdEmpresa_in_eg_x_inv, dbo.fa_factura_x_in_Ing_Egr_Inven.IdSucursal_in_eg_x_inv, 
                  dbo.fa_factura_x_in_Ing_Egr_Inven.IdMovi_inven_tipo_in_eg_x_inv, dbo.fa_factura_x_in_Ing_Egr_Inven.IdNumMovi_in_eg_x_inv
FROM     dbo.fa_factura INNER JOIN
				  ...
				  inner join fa_cliente on dbo.fa_factura.IdEmpresa = fa_cliente.IdEmpresa and dbo.fa_factura.IdCliente= fa_cliente.IdCliente
				  inner join tb_persona on dbo.fa_cliente.IdPersona = tb_persona.IdPersona