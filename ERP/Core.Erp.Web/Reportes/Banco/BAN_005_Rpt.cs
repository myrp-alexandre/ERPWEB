...
namespace Core.Erp.Web.Reportes.Banco
{
    public partial class BAN_005_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void BAN_005_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            int NumDesde = p_IdTipocbte.Value == null ? 0 : Convert.ToInt32(p_IdTipocbte.Value);
            int NumHasta = p_IdTipocbte.Value == null ? 0 : Convert.ToInt32(p_IdTipocbte.Value);
            int IdBanco = p_IdTipocbte.Value == null ? 0 : Convert.ToInt32(p_IdTipocbte.Value);
