...
{
    public partial class INV_011_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void VWINV_002_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            INV_011_Bus bus_rpt = new INV_011_Bus();
            List<INV_011_Info> lst_rpt = bus_rpt.get_list(IdEmpresa, IdSucursal, IdMovi_inven_tipo, IdNumMovi);
