...
namespace Core.Erp.Web.Reportes.RRHH
{
    public partial class ROL_009_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ROL_009_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            List<ROL_009_Info> lst_rpt = bus_rpt.get_list(Convert.ToDateTime( p_fecha_inicio.Value),Convert.ToDateTime( p_fecha_fin.Value), IdEmpresa,estado_noveda.Value.ToString(),IdRubro.Value.ToString());
