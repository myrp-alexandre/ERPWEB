                ...
                using (Entities_rrhh Context = new Entities_rrhh())
                {
                    ...
                    foreach (var item in info.lst_nomina_horas_extras)
                    {
                        ro_nomina_x_horas_extras_det content_det = new ro_nomina_x_horas_extras_det()
                        {
                            ...
                            Valor25= Math.Round((item.Sueldo_base/240)*item.hora_extra25*1.25,2),
                            Valor50=Math.Round( (item.Sueldo_base / 240) * item.hora_extra25 *1.5,2),
                            Valor100=Math.Round( (item.Sueldo_base / 240) * item.hora_extra25 * 2,2),
