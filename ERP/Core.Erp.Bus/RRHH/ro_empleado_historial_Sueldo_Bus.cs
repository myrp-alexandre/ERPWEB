...
{
   public class ro_empleado_historial_Sueldo_Bus
    {
        ro_empleado_historial_Sueldo_Data odata = new ro_empleado_historial_Sueldo_Data();
        ...
        public ro_empleado_historial_Sueldo_Info get_info(int IdEmpresa, int IdEmpleado, int Secuencia)
        {
            try
            {
